...
export default class headerQuestion extends Component {
  render() {
    return (
      <View>
        {/* head */}
        ...
        <View>
          <View style={styles.perfil}>
            ...
            <View style={styles.dados}>
              ...
              <Text style={styles.pontos}>Pontos: {this.props.userPontos}</Text>
            </View>
          </View>
        </View>
        {/* body */}
        <View style={styles.pegunta}>
          <Text style={styles.valor}>
            <Icon type="FontAwesome" name="star" style={styles.icon} />{" "}
            {this.props.valor}
          </Text>
          <Text style={styles.conteudo}>{this.props.conteudo}</Text>
        </View>
      </View>
    );
  }
